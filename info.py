...
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+LiculEMi1n02ZDg1')
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002176735817'))
...
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002463365481'))
